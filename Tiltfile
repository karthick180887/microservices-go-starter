...
### MongoDB ###
docker_build(
  'ride-sharing/mongodb',
  '.',
  dockerfile='./infra/development/docker/mongodb.Dockerfile',
)
...
if os.name == 'nt':
  gateway_compile_cmd = 'call infra/development/docker/api-gateway-build.bat'
...
if os.name == 'nt':
 trip_compile_cmd = 'call infra/development/docker/trip-build.bat'
...
if os.name == 'nt':
 driver_compile_cmd = 'call infra/development/docker/driver-build.bat'
...
if os.name == 'nt':
  payment_compile_cmd = 'call infra/development/docker/payment-build.bat'
